          ...
          <div className="mt-1">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input type="number" required className="apperance-none w-full px-3 py-2 border border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500" />
              </div>
            ) : null}
          </div>
          <button className="mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 foccus:outline-none">
